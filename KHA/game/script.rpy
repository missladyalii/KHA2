...
define pov = Character ('[povname]', color="#c8c8ff")
...
label start:
    ...
    pov "Yes! I'm here for the KHA program."
    ...
    pov "Is there anything I should know before I start?"
...
label firstdayopt :
    menu firstmeet:
        "Meet the Principal":
            ...
            pov "I would like to meet the principal."
